...
RMenu:Get('mortmenuambu', 'maines'):SetRectangleBanner(0, 0, 0, 0)
RMenu:Get('signalenvoyer', 'maines'):SetRectangleBanner(0, 0, 0, 0)
	...
	Citizen.CreateThread(function()
		while menuambulancejoblol do
				...
				RageUI.IsVisible(RMenu:Get('mortmenuambu', 'maines'), true, true, true, function()
					...
					RageUI.Separator("")
                    RageUI.Button("Appuyez sur ~g~ENTRER~s~ pour envoyer le signal", nil, {}, true, function(h, a, s)
						if s then
				...
				RageUI.IsVisible(RMenu:Get('signalenvoyer', 'maines'), true, true, true, function()
					...
					RageUI.Separator("")
                    RageUI.Button("Position envoyer..", "~o~Tu dois attendre qu'un ~g~EMS~o~ viennent a ton secours", {}, true, function(h, a, s)
						if s then
                        end
					end)
